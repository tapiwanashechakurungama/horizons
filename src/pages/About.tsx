    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-purple-50 via-white to-purple-100">
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About TechVision</h1>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <AnimatedSection className="lg:w-1/2" animation="fade">
              ...
              <p className="text-gray-600 mb-6">
                TechVision was founded in 2018 with a simple but ambitious mission: to help businesses in Zimbabwe 

        ...
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Have a question or want to discuss a project? Get in touch with our team today.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-12">
            <AnimatedSection className="lg:w-1/3" animation="fade">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                   ...
                   <p className="text-gray-600">+263 780008760</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">chakurungamatapiwanashe@hotmail.com</p>
                  </div>
                </div>
            ...
            <AnimatedSection className="lg:w-2/3" animation="slide">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Visit our office in Harare, Zimbabwe or reach out to us online.
            </p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <a
              ...
              className="bg-primary hover:bg-purple-700 text-white font-medium py-3 px-8 rounded-md transition-colors duration-300 inline-block"
            >
              Call Us Now
            </a>
          </AnimatedSection>

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/gadget-shipping" className="text-gray-300 hover:text-white transition-colors">
                  Gadget Shipping
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <Phone className="mr-3 h-6 w-6 text-primary flex-shrink-0" />
                <span className="text-gray-300">+263 733 517 788</span>
              </li>
              <li className="flex items-center">
                <Mail className="mr-3 h-6 w-6 text-primary flex-shrink-0" />
                <span className="text-gray-300">support@neichnice.co.zw</span>
              </li>
            </ul>
          </div>
        </div>
